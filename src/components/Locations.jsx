...
export default function Locations({ showToast }) {
  ...
  return (
    <section id="locations" className="py-24 bg-[#1A1D20] text-white relative overflow-hidden border-b border-gray-800">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[500px] bg-[#D8235C]/10 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div 
            ...
            className="p-8 sm:p-10 rounded-3xl bg-[#24282D] border border-gray-700 shadow-2xl flex flex-col gap-6 relative"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-2">
              <div className="flex items-start gap-4 text-sm sm:text-base text-gray-300">
                ...
                <div>
                  <span className="block text-xs text-gray-400 font-medium mb-0.5">Address</span>
              ...
              <div className="flex items-start gap-4 text-sm sm:text-base text-white font-heading font-bold">
                ...
                <div>
                  <span className="block text-xs text-gray-400 font-normal mb-0.5">Phone Contact</span>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <span className="px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-xs font-bold text-emerald-400 shrink-0">
                Open Now
              </span>
            </div>
            ...
            <button 
              onClick={handleCopy}
              className="mt-2 w-full py-4 rounded-full bg-[#D8235C] hover:bg-[#B81B4B] text-white font-heading font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 hover:scale-[1.01] transition-transform shadow-xl"
            >
